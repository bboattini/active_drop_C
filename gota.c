...
// -------------------------------------------------------------------------------------------
	...
	fprintf(fp1,"%8d %d %d %d %f %f %f %f %f %f %f %f %f %f %f %f %f %d %d %d %d %f %f %f %f %f %f %f %f %f %f\n", num_steps, (int)vol, (int)vol_w, (int)vol_o, calculate_energy(), base_radius_x, base_radius_y, base_radius_x_o, base_radius_y_o, rx, ry, rx_o, ry_o, angle_x, angle_y, angle_x_o, angle_y_o, num_pil_x,num_pil_y, num_pil_x_o,num_pil_y_o, volume_below, volume_below_o, volume_res,volume_res_o, per_w, per_o, frac_w, frac_o, vol_p_w, vol_p_o);
	fflush(fp1);
